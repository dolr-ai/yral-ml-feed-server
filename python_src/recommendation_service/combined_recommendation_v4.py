...
class CombinedRecommendationV4:
    def __init__(self):
        cfg = Config()
...
## 
    ...
    def get_collated_recommendation(
        ...
        if self.logging:
            ...
            log_file = os.path.join(self.log_dir, f"combined_recommendation_v3_{timestamp}_{user_principal_id}_{uuid.uuid4()}.json")
            ...
            _LOGGER.info(f"Combined recommendation V4 data logged to {log_file}")
...
if __name__ == "__main__":
    ...
    recommender = CombinedRecommendationV4()
