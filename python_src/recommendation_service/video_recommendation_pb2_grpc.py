...
class MLFeedStub(object):
    ...
    def __init__(self, channel):
        ...
        self.get_ml_feed_combined_v3 = channel.unary_unary(
                ...
                response_deserializer=video__recommendation__pb2.MLFeedResponseV3.FromString,
                _registered_method=True)
        self.report_video_v3 = channel.unary_unary(
                '/ml_feed_py.MLFeed/report_video_v3',
                request_serializer=video__recommendation__pb2.VideoReportRequestV3.SerializeToString,
                response_deserializer=video__recommendation__pb2.VideoReportResponseV3.FromString,
                _registered_method=True)
        self.get_ml_feed_clean_v4 = channel.unary_unary(
                '/ml_feed_py.MLFeed/get_ml_feed_clean_v4',
                request_serializer=video__recommendation__pb2.MLFeedRequestV4.SerializeToString,
                response_deserializer=video__recommendation__pb2.MLFeedResponseV4.FromString,
                _registered_method=True)
        self.get_ml_feed_nsfw_v4 = channel.unary_unary(
                '/ml_feed_py.MLFeed/get_ml_feed_nsfw_v4',
                request_serializer=video__recommendation__pb2.MLFeedRequestV4.SerializeToString,
                response_deserializer=video__recommendation__pb2.MLFeedResponseV4.FromString,
                _registered_method=True)
        self.get_ml_feed_combined_v4 = channel.unary_unary(
                '/ml_feed_py.MLFeed/get_ml_feed_combined_v4',
                request_serializer=video__recommendation__pb2.MLFeedRequestV4.SerializeToString,
                response_deserializer=video__recommendation__pb2.MLFeedResponseV4.FromString,
                _registered_method=True)
...
def add_MLFeedServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'report_video_v3': grpc.unary_unary_rpc_method_handler(
                    servicer.report_video_v3,
                    request_deserializer=video__recommendation__pb2.VideoReportRequestV3.FromString,
                    response_serializer=video__recommendation__pb2.VideoReportResponseV3.SerializeToString,
            ),
            'get_ml_feed_clean_v4': grpc.unary_unary_rpc_method_handler(
                    servicer.get_ml_feed_clean_v4,
                    request_deserializer=video__recommendation__pb2.MLFeedRequestV4.FromString,
                    response_serializer=video__recommendation__pb2.MLFeedResponseV4.SerializeToString,
            ),
            'get_ml_feed_nsfw_v4': grpc.unary_unary_rpc_method_handler(
                    servicer.get_ml_feed_nsfw_v4,
                    request_deserializer=video__recommendation__pb2.MLFeedRequestV4.FromString,
                    response_serializer=video__recommendation__pb2.MLFeedResponseV4.SerializeToString,
            ),
            'get_ml_feed_combined_v4': grpc.unary_unary_rpc_method_handler(
                    servicer.get_ml_feed_combined_v4,
                    request_deserializer=video__recommendation__pb2.MLFeedRequestV4.FromString,
                    response_serializer=video__recommendation__pb2.MLFeedResponseV4.SerializeToString,
            ),
    }
...
class MLFeed(object):
    ...
    def report_video_v3(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/ml_feed_py.MLFeed/report_video_v3',
            video__recommendation__pb2.VideoReportRequestV3.SerializeToString,
            video__recommendation__pb2.VideoReportResponseV3.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    @staticmethod
    def get_ml_feed_clean_v4(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/ml_feed_py.MLFeed/get_ml_feed_clean_v4',
            video__recommendation__pb2.MLFeedRequestV4.SerializeToString,
            video__recommendation__pb2.MLFeedResponseV4.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    @staticmethod
    def get_ml_feed_nsfw_v4(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
    ...
    @staticmethod
    def get_ml_feed_combined_v4(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
