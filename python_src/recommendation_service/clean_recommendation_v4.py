...
--        LIMIT {search_breadth}
    ...
    def get_collated_recommendation(
        ...
        if self.logging:
            ...
            log_file = os.path.join(self.log_dir, f"clean_recommendation_v4_{timestamp}_{user_principal_id}_{uuid.uuid4()}.json")
            ...
            _LOGGER.info(f"Clean recommendation V4 data logged to {log_file}")
...
if __name__ == "__main__":
    ...
    recommender = CleanRecommendationV4()
